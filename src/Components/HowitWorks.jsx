...
const HowitWorks = () => {
    return (
        <div className="px-12 py-20 mt-12 bg-[#f6faff]">
            <h2 className='text-4xl font-medium mb-10'>How it Works</h2>

            <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
                <div className="p-16 border-2 bg-white rounded-2xl">
                    <div className="px-3 py-1 rounded-md bg-[#F2F4F6] w-fit font-semibold">
                        <p>step 1</p>
                    </div>
                    <div className="mt-3 flex ml-auto bg-[#f6faff] p-2 rounded-lg w-fit">
                    <SlNote className="text-3xl text-[#295dfa]"/>
                    </div>
                    <div>
                ...
                <div className="p-16 border-2 bg-white rounded-2xl">
                    <div className="px-3 py-1 rounded-md bg-[#f6faff] w-fit font-semibold">
                        <p>step 2</p>
                    </div>
                    <div className="mt-3 flex ml-auto bg-[#f6faff] p-2 rounded-lg w-fit">
                    <IoCheckmarkCircleOutline className="text-3xl text-[#295dfa]"/>
                    </div>
                    <div>
                ...
                <div className="p-16 border-2 bg-white rounded-2xl">
                    ...
                    <div className="mt-3 flex ml-auto bg-[#f6faff]   p-2 rounded-lg w-fit">
                    <GrMoney className="text-3xl text-[#295dfa]"/>
                    </div>
                    <div>
